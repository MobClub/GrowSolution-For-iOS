...
SWIFT_CLASS("_TtC9YLDataSDK15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(YLDataSDK)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(YLDataSDK)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(YLDataSDK)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(YLDataSDK)) <NSURLSessionStreamDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(YLDataSDK)) <NSURLSessionTaskDelegate>
...
SWIFT_CLASS("_TtC9YLDataSDK12TaskDelegate")
...
enum YLFeedLoadType : NSInteger;
@class YLFeedModel;

SWIFT_CLASS("_TtC9YLDataSDK6YLFeed")
@interface YLFeed : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) YLFeed * _Nonnull shared;)
+ (YLFeed * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
+ (void)setShared:(YLFeed * _Nonnull)value;
/// 频道列表
- (void)getChannelsWithCallback:(void (^ _Nonnull)(BOOL, NSArray<YLChannelModel *> * _Nonnull))callback;
/// 频道信息流
- (void)getFeedListWithChannelId:(NSString * _Nonnull)channelId loadType:(enum YLFeedLoadType)loadType callback:(void (^ _Nonnull)(BOOL, NSArray<YLFeedModel *> * _Nonnull))callback;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface YLFeedModel : YLHandyJSON
...
- (void)videoShowWithVideoID:(NSString * _Nonnull)videoID logID:(NSString * _Nonnull)logID referPage:(NSString * _Nonnull)referPage;
- (void)videoPlayWithVideoID:(NSString * _Nonnull)videoID logID:(NSString * _Nonnull)logID referPage:(NSString * _Nonnull)referPage;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC9YLDataSDK17YLVideoShowReport")
@interface YLVideoShowReport : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) YLVideoShowReport * _Nonnull shared;)
+ (YLVideoShowReport * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (void)displayVideo:(YLFeedModel * _Nonnull)data channel:(NSString * _Nonnull)channel;
- (void)hideVideo:(YLFeedModel * _Nonnull)data channel:(NSString * _Nonnull)channel;
- (void)reportAll;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
